    ...
    entries: [
      {
        ...
        bullets: [
          ...
          "работала в связке с разработкой: предлагала варианты реализации, согласовывала продуктовые решения с учётом технических ограничений и доводила макеты до прода",
        ],
      },
      {
        title: "сбер",

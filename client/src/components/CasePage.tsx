      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            body: {
              column: [
                "проблема обнаружилась во время интервью по другой фиче. исследования — лютый прикол: провожу сама или на пару с продактом/ресерчером, качественные и количественные",
              ],
            },
          },
          {
    ...
    blocks: [
      ...
      { block: "media", src: "/bubble/02-good-shit-happens.webp" },
      {
        ...
        rows: [
          ...
          {
            label: "качественное тисследование",

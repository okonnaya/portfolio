...
const CASES: Record<string, Case> = {
  ...
  "ai-research-platform": {
    ...
    blocks: [
      ...
      { block: "media", src: "/case3_2.webm" },
      {
        block: "section",
        label: "",
        body: {
          text: "концепт цифровой платформы для ai-ресёрчеров и бизнеса в одной из крупнейших российских компаний. соло-дизайнер на проекте: ресёрч, проектирование ключевых страниц, сборка презентации и защита концепции перед топ-менеджментом",
        },
      },
      {
        block: "section",
      ...
      },
      {
        ...
        body: {
          bullets: [
            ...
            "из-за всего этого ресурсы компании тратятся неэффективно",
          ],
        },
      },
      { block: "media" },
      {
        ...
        rows: [
          ...
          {
            label: "user flow",
            text: "собрала флоу по 4 сценариям: бизнес, менеджер, учёный, внешний учёный",
          },
          {
            label: "проектирование",
            text: "спроектировала интерфейс ключевых страниц по сценариям",
          },
          {
            label: "защита",
            text: "собрала презентацию и защитила концепцию перед топ-менеджментом → проект ушёл в разработку",
          },
        ],
      },
      { block: "media" },

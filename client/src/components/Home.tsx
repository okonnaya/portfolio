    ...
    >
      ...
      <Canvas
        ...
        style={{
          ...
          width: "100%",
          height: "100%",
          // z-index:0 (не 1): канвас должен попасть в «фон» блендинга hero-текста
          // (mix-blend-mode: difference). hero больше не изолирован (снят z-index),
          // поэтому текст смешивается с реальным фоном — белой страницей и кругами.
          // канвас идёт раньше hero в DOM → на уровне z:0 рисуется под ним
          zIndex: 0,
          pointerEvents: "none",
        }}
      />

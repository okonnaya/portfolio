...
const COLOR2 = "#FEAAFF";
const COLOR3 = "#FF69B4";
const SIZE_VH = 0.2; // диаметр частицы в долях высоты вьюпорта (0.025 = 2.5vh)
const COVERAGE = 1; // доля площади под первыми частицами
const SECONDARY = 1; // множитель к числу первых → сколько вторых кластерами
